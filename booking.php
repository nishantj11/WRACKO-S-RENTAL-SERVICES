...
<div class="bg-div" style="margin-left: 34%;">
    ...
    <h1 style="text-align: center; margin-top: 40px;">Booking</h1>
<table>
  <tr>
    <th>Name</th>
    <th>Seater</th>
  ...
  <tr>
    ...
    <td>Rs 400/-</td>
    <td>Rs 6000/-</td>
    <td><button onclick="window.location.href='success.php'">Book</button>
  </tr>
  <tr>
    <td>Hyundai Creta</td>
    <td>7</td>
